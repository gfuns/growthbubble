...
@section('content')
@section('title', env('APP_NAME') . ' | User Defined Report')
<style type="text/css">
    .button-container {
        display: flex;
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                    ...
                    <div class="card mb-4">
                        <!-- table -->
                        <form method="POST" action="{{ route('report.processUserDefinedReport') }}" target="_blank">
                            @csrf
                            <div class="col-12 col-lg-8 table-responsive overflow-y-hidden ps-4 mt-5 pe-4 mb-5">
                                <table class="table mb-0 text-nowrap table-hover table-centered table-bordered"
                                    style="font-size: 12px">
                                    <thead>
                                        <tr>
                                            <th scope="col" width="30%">Period</th>
                                            <td scope="col">
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col">
                                                <div class="pb-2" style="color:#3fbae4; font-weight:bold">
                                                    Please select the allowances you want to include in the report. (Maximum of 5)</div>
                                                @foreach ($allowances as $allow)
                                                    <div class="form-check mb-2">
                                                        <input name="allowances[]"
                                                            class="form-check-input form-check-input-lg" type="checkbox"
                                                            value="{{ $allow->sql_label }}" id="flexCheckChecked">
                                                        <label class="form-check-label" for="flexCheckChecked"
                                                            style="font-size:13px;"><strong>
                                                                {{ ucwords(strtolower($allow->allowance_name)) }}</strong>
                                                        </label>
                                                    </div>
                                                @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col">
                                                <div class="pb-2" style="color:#3fbae4; font-weight:bold">
                                                    Please select the deductions you want to include in the report. (Maximum of 5)</div>
                                                @foreach ($deductions as $ded)
                                                    <div class="form-check mb-2">
                                                        <input name="deductions[]"
                                                            class="form-check-input form-check-input-lg" type="checkbox"
                                                            value="{{ $ded->sql_label }}" id="flexCheckChecked">
                                                        <label class="form-check-label" for="flexCheckChecked"
                                                            style="font-size:13px;"><strong>
                                                                {{ ucwords(strtolower($ded->deduction_name)) }}</strong>
                                                        </label>
                                                    </div>
                                                @endforeach
                                                @error('deductions')
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col">
                                                <select id="paygroup" name="paygroup" class="custom-select"
                                                    data-width="100%">
                                                    <option value="All">---All---</option>
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col">
                                                <select id="format" name="format" class="custom-select" data-width="100%" required>
