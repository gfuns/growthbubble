    ...
    <div class="container">
        ...
        <table class="table table-bordered table-striped mb-5"
            ...
            <tr class="cate table-light">
                ...
                @else
                    <th class="text-right">{{ $groupDeductions->deduction_name }}</th>
                @endif
                {{-- <th>Period</th> --}}
            </tr>
            @php
            ...
            @foreach ($deductionRecords as $data)
                <tr>
                    ...
                    @else
                        <td>&#8358;{{ number_format($data->{$deductionType}, 2) }}</td>
                    @endif
                    {{-- <td>{{ $data->period }}</td> --}}
                </tr>
            @endforeach
            <tr>
                ...
                <th class="text-right">&#8358;{{ number_format($deductions, 2) }}</th>
            </tr>
