...
@section('content')
@section('title', env('APP_NAME') . ' | Payrol MDA Report By Bank')
<style type="text/css">
    .button-container {
        display: flex;
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                    ...
                    <div class="card mb-4">
                        <!-- table -->
                        <form method="POST" action="{{ route('report.processPayrolMDABankReport') }}" target="_blank">
                            @csrf
...
<script type="text/javascript">
    ...
    $('#branch').change(function() {
        ...
        $.ajax({
            url: "/ajax/get-departments/" + branch,
            type: "GET",
            dataType: "json",
            success: function(data) {
                var options = "<option value='All'>---All---</option>";
