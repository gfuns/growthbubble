...
@section('content')
@section('title', env('APP_NAME') . ' | Payrol Report Per Pay Station')
<style type="text/css">
    .button-container {
        display: flex;
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                    ...
                    <div class="card mb-4">
                        <!-- table -->
                        <form method="POST" action="{{ route('report.processPayrolReportPPS') }}" target="_blank">
                            @csrf
                            <div class="col-12 col-lg-8 table-responsive overflow-y-hidden ps-4 mt-5 pe-4 mb-5">
                                <table class="table mb-0 text-nowrap table-hover table-centered table-bordered"
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            <th scope="col">Pay Station</th>
                                            <td scope="col">
                                                <select id="paystattion" name="branch" class="custom-select"
                                                    data-width="100%">
                                                    <option value="All">---All---</option>
