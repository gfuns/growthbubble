...
<head>
    ...
    <title>Employee Reinstatement Report</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        ...
        <div class="ms-3 row mb-5 mt-5 me-2">
            ...
            <div class="col-6" style="color:black">
                ...
                <span style="font-size:16px; display:block;">
                    @if ($period == 'All')
                        All Time Employee Reinstatement Report
                    @else
                        Employee Reinstatement Report For {{ $period }}
                    @endif
        ...
        <table class="table table-bordered table-striped mb-5"
            ...
            @foreach ($reinstatementRecords as $data)
                <tr>
                    <td>{{ $loop->index + 1 }}</td>
