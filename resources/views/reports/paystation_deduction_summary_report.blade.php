...
@section('content')
@section('title', env('APP_NAME') . ' | Deduction Summary Report Per Pay Station')
<style type="text/css">
    .button-container {
        display: flex;
            ...
            <div class="border-bottom pb-4 mb-4 d-flex justify-content-between align-items-center">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-1 h4 fw-bold">
                        Deduction Summary Report Per Pay Station
                    </h1>
                </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                    ...
                    <div class="card mb-4">
                        ...
                        <!-- table -->
                        <form method="POST" action="{{ route('report.processDeductionSummaryReportPPS') }}" target="_blank">
                            @csrf
                            <div class="col-12 col-lg-7 table-responsive overflow-y-hidden ps-4 mt-5 pe-4 mb-5">
                                ...
                                @if (Session::has('alert'))
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Not Available at the moment.</strong>
