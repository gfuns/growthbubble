...
<head>
    ...
    <title>Employee Variation Report</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        ...
        <div class="ms-3 row mb-5 mt-5 me-2">
            ...
            <div class="col-6" style="color:black">
                ...
                <span style="font-size:16px; display:block;">
                    @if ($period == 'All')
                        All Time Employee Variation Report
                    @else
                        Employee Variation Report For {{ $period }}
                    @endif
        ...
        <table class="table table-bordered table-striped mb-5"
            ...
            <tr class="cate table-light">
                ...
                <th>Employee No.</th>
                <th>Employee Name</th>
                <th>Former GL/Step</th>
                <th>Current GL/Step</th>
            ...
            @foreach ($promotionRecords as $data)
                <tr>
                    <td>{{ $loop->index + 1 }}</td>
                    <td>{{ $data->employee_number }}</td>
                    <td>{{ $data->employee_name }}</td>
                    <td>{{ $data->old_level . '/' . $data->old_step }}</td>
                    <td>{{ $data->new_level . '/' . $data->new_step }}</td>
