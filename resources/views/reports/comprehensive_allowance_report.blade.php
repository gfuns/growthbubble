...
@section('content')
@section('title', env('APP_NAME') . ' | Comprehensive Allowance Report')
<style type="text/css">
    .button-container {
        display: flex;
            ...
            <div class="border-bottom pb-4 mb-4 d-flex justify-content-between align-items-center">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-1 h4 fw-bold">
                        Comprehensive Allowance Report
                    </h1>
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                    ...
                    <div class="card mb-4">
                        <!-- table -->
                        <form method="POST" action="{{ route('report.processComprehensiveAllowanceReport') }}" target="_blank">
                            @csrf
