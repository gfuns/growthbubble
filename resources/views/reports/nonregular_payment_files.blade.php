...
@section('content')
@section('title', env('APP_NAME') . ' | Non Regular Payment Files Report')
<style type="text/css">
    .button-container {
        display: flex;
            ...
            <div class="border-bottom pb-4 mb-4 d-flex justify-content-between align-items-center">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-1 h4 fw-bold">
                        Non Regular Payment Files Report
                    </h1>
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                    ...
                    <div class="card mb-4">
                        <!-- table -->
                        <form method="POST" action="{{ route('report.processNonRegularPaymentsReport') }}" target="_blank">
                            @csrf
                            <div class="col-12 col-lg-8 table-responsive overflow-y-hidden ps-4 mt-5 pe-4 mb-5">
                                <table class="table mb-0 text-nowrap table-hover table-centered table-bordered"
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            <th scope="col" width="30%">Payment File</th>
                                            <td scope="col">
                                                <select id="level" name="payment_file" class="custom-select"
                                                    data-width="100%" required>
                                                    <option value="All">---All---</option>
