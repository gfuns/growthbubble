...
@section('content')
@section('title', env('APP_NAME') . ' | Allowance Report')
<style type="text/css">
    .button-container {
        display: flex;
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                    ...
                    <div class="card mb-4">
                        <!-- table -->
                        <form method="POST" action="{{ route('report.processAllowanceReport') }}" target="_blank">
                            @csrf
                                ...
                                <table class="table mb-0 text-nowrap table-hover table-centered table-bordered"
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col">
                                                <select id="allowance" name="allowance" class="custom-select" data-width="100%" required>
                                                    <option value="All">---All---</option>
                                                    @foreach ($allowances as $allow)
                                                        <option value="{{ $allow->sql_label }}">{{ ucwords(strtolower($allow->allowance_name)) }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('allowance')
