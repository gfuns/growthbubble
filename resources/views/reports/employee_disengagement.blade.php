...
@section('content')
@section('title', env('APP_NAME') . ' | Employee Disengagement Report')
<style type="text/css">
    .button-container {
        display: flex;
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                    ...
                    <div class="card mb-4">
                        <!-- table -->
                        <form method="POST" action="{{ route('report.processEmployeeDisengagement') }}" target="_blank">
                            @csrf
