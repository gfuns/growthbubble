...
@section('content')
@section('title', env('APP_NAME') . ' | Arrears Report')
<style type="text/css">
    .button-container {
        display: flex;
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                    ...
                    <div class="card mb-4">
                        <!-- table -->
                        <form method="POST" action="{{ route('report.processArrearsReport') }}" target="_blank">
                            @csrf
                            <div class="col-12 col-lg-8 table-responsive overflow-y-hidden ps-4 mt-5 pe-4 mb-5">
                                ...
                                @if (Session::has('alert'))
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Report Not Available at the moment.</strong>
