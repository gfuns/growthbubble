                ...
                <div class="card border-0 mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="text" name="task_summary" id="title" class="form-control text-dark"
...
<script>
    $('#customer').change(function() {
        ...
        $.ajax({
            url: "/ajax/get-websites/" + customerId,
            type: "GET",
            dataType: "json",
            success: function(data) {
                var options = "<option value=''>Select Customer Website</option>";
