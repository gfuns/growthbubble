    ...
    <div class="container">
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <th>Date</th>
                    <td>{{ date_format_format(now(), 'jS M, Y') }}</td>
                </tr>
                <tr>
                    <th>Error message</th>
        ...
        <div class="code">
            <a href="{{ route("admin.subscriptions") }}">
                <button class="btn btn-primary btn-md"
                    style="background: #0716AD; border: #0716AD; color:white; padding:15px; border-radius: 5px; font-weight:bold; font-size: 14px ">View Billing Dashboard</button>
            </a>
        </div>

        <p>Please review and follow up if necessary.</p>
