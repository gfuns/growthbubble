...
<body>
    <div class="container">
        ...
        <div class="code">
            <a href="{{ env("APP_URL") }}/reset/password/{{ $user->token }}">
                <button class="btn btn-primary btn-md"
                    style="background: #0716AD; border: #0716AD; color:white; padding:15px; border-radius: 5px; font-weight:bold; font-size: 14px ">Reset
                    Password</button>
            </a>
        </div>
        ...
        <p>
            ...
            browser:
            <a href="{{ env("APP_URL") }}/reset/password/{{ $user->token }}">{{ env("APP_URL") }}/reset/password/{{ $user->token }}</a>
        </p>
