...
<head>
    ...
    <title>Got a marketing task in mind?</title>
    <style>
        /* CSS Styles */
        body {
...
<body>
    <div class="container">
        ...
        <ul>
            <li>Refresh your website content</li>
            <li>Schedule an email campaign</li>
            <li>Design new social posts</li>
        </ul>

        <div class="code">
            <a href="{{ route('customer.newCustomerTask', [1]) }}">
                <button class="btn btn-primary btn-md"
                    style="background: #0716AD; border: #0716AD; color:white; padding:15px; border-radius: 5px; font-weight:bold; font-size: 14px ">Submit a New Task</button>
            </a>
        </div>

        <p>Let’s keep your marketing moving forward.</p>
