...
<head>
    ...
    <title>Your Growth Bubbles subscription has renewed</title>
    <style>
        /* CSS Styles */
        body {
...
<body>
    <div class="container">
        ...
        <p>Your Growth Bubbles Concierge subscription has renewed successfully.</p>
        ...
        <div class="code">
            <a href="{{ route('customer.newCustomerTask', [$sub->product->id]) }}">
