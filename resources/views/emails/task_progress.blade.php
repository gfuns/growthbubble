...
<head>
    ...
    <title>We’ve started working on your task 🛠️</title>
    <style>
        /* CSS Styles */
        body {
...
<body>
    <div class="container">
        ...
        <p>Good news — we’ve started working on your task:</p>
        ...
        <p>You’ll receive an update once it’s completed or if we need any clarification.</p>
