                        ...
                        <div class="card-body p-6">
                            <div class="mb-4 row">
                                <div class="col-md-3 col-4">
                                    <a href="/"><img src="{{ asset('images/logo.png') }}" class="mb-4" alt=""
                            ...
                            @endif
                            <!-- Form -->
                            <form class="needs-validation" novalidate method="post" action="{{ route('login.2fa') }}">
                                @csrf
                                <!-- Username -->
                                <div class="mb-3">
                                    <input type="text" id="gacode" name="google2fa_code" class="form-control"
                                        placeholder="Enter your google authentication code"
                                        value="{{ old('confirmation_code') }}" maxlength="6" required>
                                    <div class="invalid-feedback">Please enter the verification code generated by your Google Authenticator Application.</div>
                                </div>
                                ...
                                <p class="mt-3 text-dark">If you lost your phone or Uninstall the Google Authenticator app and
