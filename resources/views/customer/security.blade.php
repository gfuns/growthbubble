            ...
            <div class="offset-xl-2 col-xl-8 col-md-12 col-12">
                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body p-lg-6">
                        <!-- form -->
                        <form method="post" action="{{ route('customer.updatePassword') }}" class="needs-validation"
                                novalidate>
                            @csrf
                            <div class="row">
                                <!-- form group -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-5">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex align-items-center justify-content-between px-0 py-2">
                                    <div class="row">
                                        <div>Get your authentication code via the Google Authenticator app for every
    ...
    <div class="modal-dialog modal-md " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-dark">
                <form action="{{ route('customer.enableGA') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="pdb-1-5x">
