                ...
                <div class="offset-xl-2 col-xl-8 col-md-12 col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-lg-6">
                            <!-- form -->
                            <form method="post" action="{{ route('customer.updateProfile') }}" class="needs-validation"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="first_name" value="{{ Auth::user()->other_names }}"
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <textarea name="contact_address" class="form-control @error('contact_address') is-invalid @enderror"
                                            placeholder="Enter Contact Address" required style="resize: none" rows="5">{{ Auth::user()->contact_address }}</textarea>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="" rowspan="8" align="right" style="text-align: center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="">{{ Auth::user()->organization }}</td>
                                    </tr>

                                    <tr>
                                        <td class="">Contact Address</td>
                                        <td class="">{{ Auth::user()->contact_address }}</td>
                                    </tr>
                                </tbody>
                            </table>
