            ...
            <tr>
                <td>
                    <div class="details-block">
                        ...
                        <p>&nbsp;</p>
                        <p><strong>Address:</strong> {{ $payment->customer->contact_address }}</p>
                    </div>
                </td>
                <td>
                    <div class="details-block">
                        ...
                        <p>&nbsp;</p>
                        <p><strong>Receipt No:</strong> {{ $payment->invoice_number }}</p>
                        <p>&nbsp;</p>
                        <p><strong>Date Issued:</strong> {{ date_format($payment->created_at, 'F j, Y') }}</p>
                        <p>&nbsp;</p>
                        <p><strong>Method:</strong> {{ $payment->payment_method }}</p>
                        <p>&nbsp;</p>
                        <p><strong>Transaction ID:</strong> {{ $payment->txn_id }}</p>
                    </div>
                </td>
            </tr>
        </table>
            ...
            <table class="receipt-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: right;">&pound;{{ number_format($payment->amount, 2) }}</td>
                    </tr>
                </tbody>
            </table>
        </section>
