...
@section('content')
@section('title', env('APP_NAME') . ' | My Projects')
                                ...
                                <div class="col-12 col-lg-9 mb-3 mb-lg-0">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input name="search" type="search" class="form-control ps-6"
                                            placeholder="Search Projects Using Project Title......"
                                            value="{{ $search }}">
                                    </div>
                                    ...
                                    @foreach ($customerProjects as $cProj)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span class="badge text-danger bg-light-danger">Closed</span>
                                                @endif
                                            </td>
                                                        ...
                                                        <span class="dropdown-menu"><span
                                                            ...
                                                            @if ($cProj->status == 'open')
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('customer.closeProject', [$cProj->id]) }}"
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" style="width: 600px;">
    <div class="offcanvas-body" data-simplebar>
        ...
        <div class="container">
            <!-- form -->
            <form class="needs-validation" novalidate method="post" action="{{ route('customer.storeProject') }}"
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="updateProject" style="width: 600px;">
    <div class="offcanvas-body" data-simplebar>
        ...
        <div class="container">
            <!-- form -->
            <form class="needs-validation" novalidate method="post" action="{{ route('customer.updateProject') }}"
                enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- form group -->
